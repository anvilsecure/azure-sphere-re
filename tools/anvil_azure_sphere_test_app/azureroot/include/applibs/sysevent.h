...
enum {
    ...
    /// <summary>
    ///     This alias has been deprecated and will be removed in a future version of
    ///     the API. Use <see cref="SysEvent_Events_UpdateReadyForInstall"/> instead.
    /// </summary>
    SysEvent_Events_Update _AZSPHERE_DEPRECATED_BY(SysEvent_Events_UpdateReadyForInstall) =
...
enum {
    ...
    /// <summary>
    ///     This alias has been deprecated and will be removed in a future version of the API.
    ///     Use <see cref="SysEvent_Status_Deferred"/> instead.
    /// </summary>
    SysEvent_Status_Rejected _AZSPHERE_DEPRECATED_BY(SysEvent_Status_Deferred) =
