...
enum {
    ...
    WifiConfig_Attribute_Config_Name = 12,
    /// <summary>Wifi Network Diagnostics.</summary>
    WifiConfig_Attribute_Network_Diagnostics = 22,
};
...
{
    return z__WifiConfig_SetNetworkOpt(-1, WifiConfig_Attribute_Reload, NULL, 0);
}
...
{
    return z__WifiConfig_SetNetworkOpt(networkId, WifiConfig_Attribute_Client_Identity, identity,
                                       0);
}
...
{
    return z__WifiConfig_SetNetworkOpt(networkId, WifiConfig_Attribute_Client_CertStore_Identifier,
...
static inline int WifiConfig_SetRootCACertStoreIdentifier(int networkId,
                                                          const char *certStoreIdentifier)
{
    return z__WifiConfig_SetNetworkOpt(networkId, WifiConfig_Attribute_RootCA_CertStore_Identifier,
                                       certStoreIdentifier, 0);
}

static inline int WifiConfig_SetConfigName(int networkId, const char *configName)
{
    return z__WifiConfig_SetNetworkOpt(networkId, WifiConfig_Attribute_Config_Name, configName, 0);
}
...
/// </returns>
ssize_t z__WifiConfig_GetNetworkOpt(int networkId, WifiConfig_Attribute networkAttribute,
...
static inline int z__WifiConfig_GetCertificateIdentifier(int networkId,
                                                         WifiConfig_Attribute certificate_type,
                                                         CertStore_Identifier *outIdentifier)
{
    ...
    if (certificate_type != WifiConfig_Attribute_Client_CertStore_Identifier &&
        certificate_type != WifiConfig_Attribute_RootCA_CertStore_Identifier) {
        errno = EINVAL;
        return -1;
    }
    ...
    int networkId, WifiConfig_NetworkDiagnostics *networkDiagnostics)
{
    ...
    ssize_t res =
        z__WifiConfig_GetNetworkOpt(networkId, WifiConfig_Attribute_Network_Diagnostics,
                                    networkDiagnostics, sizeof(WifiConfig_NetworkDiagnostics));
    if (res == -1) {
        return -1;
    }
                                               ...
                                               WifiConfig_ClientIdentity *outIdentity)
{
    ...
    ssize_t bytes_read = z__WifiConfig_GetNetworkOpt(
        networkId, WifiConfig_Attribute_Client_Identity, buffer, bufferLength);
                                                          ...
                                                          CertStore_Identifier *outIdentifier)
{
    return z__WifiConfig_GetCertificateIdentifier(
        networkId, WifiConfig_Attribute_Client_CertStore_Identifier, outIdentifier);
}
...
{
    return z__WifiConfig_GetCertificateIdentifier(
        networkId, WifiConfig_Attribute_RootCA_CertStore_Identifier, outIdentifier);
}
